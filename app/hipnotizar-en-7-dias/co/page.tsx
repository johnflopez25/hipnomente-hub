...
// Paid-traffic variant for Meta Ads campaigns targeting Colombia — same page as
...
export default function DesafioHipnotizarCOPage() {
  return <DesafioLanding market="co" />;
}
